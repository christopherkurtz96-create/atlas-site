            ...
            <div class="service-detail-grid">
                <div class="service-detail-content">
                    <form id="bid-lead-form" name="instant-bid" method="POST" action="/thank-you" data-netlify="true" netlify-honeypot="bot-field" enctype="multipart/form-data" class="bid-intake">
                        ...
                        <h2>2. The site</h2>
                        <div class="form-group">
                            <label for="bid-address">Property address</label>
                            <input type="text" id="bid-address" name="propertyAddress" class="bid-input" required autocomplete="street-address" placeholder="Street, town">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="bid-call-time">Best time to call</label>
                            <select id="bid-call-time" name="bestTimeToCall" class="bid-input" required>
